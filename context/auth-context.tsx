...
type AuthContextType = {
  ...
  registerUser: (payload: { name: string; email: string; password: string }) => Promise<void>;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const loginWithBiometrics = async () => {
    ...
    if (!email || !password) {
      throw new Error('No biometric credentials found. Login once and enable biometrics.');
    }
